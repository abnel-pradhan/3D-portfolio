...
function FloatingImagePlane({ imageUrl }) {
  // This loads your image and turns it into a 3D texture
  ...
  useFrame((state) => {
    ...
    // Makes the image gently float and rotate
...
export default function Hero({ isMobile }) {
  ...
  // It can be a web link like this, or a local file like "/abnel.png"
  const MY_IMAGE_URL = "/abnel.png";
      ...
      <div className="container-x w-full grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
        ...
        >
          <div className="section-label mb-6">
            <span>BCA / Builder / Sikkim</span>
          </div>
          <h1 className="font-display text-[15vw] md:text-[8.5vw] leading-[0.85] tracking-tighter uppercase">
            Abnel
            <br />
            <span className="text-[color:var(--accent)]">Pradhan</span>
            <span className="text-white">.</span>
          </h1>
          <p className="mt-8 max-w-xl text-sm md:text-base text-[color:var(--muted)] leading-relaxed">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            <a href="#projects" className="btn-sharp btn-primary">
              View Work <ArrowDownRight size={16} />
            </a>
            <a href="#ai" className="btn-sharp">
        ...
        >
          ...
          >
            ...
            <Suspense fallback={null}>
              ...
              {/* This is where your image gets rendered in 3D! */}
              <FloatingImagePlane imageUrl={MY_IMAGE_URL} />
              ...
              {!isMobile && (
                <>
                  ...
                  <GlassShard position={[-2.3, -1.8, -1.5]} rotation={[0.2, 0.3, 0.5]} scale={0.35} />
                </>
              )}
              <Accent />
